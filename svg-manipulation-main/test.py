...
def Read_JSON_File():
    ...
    # returns JSON object as a directory
...
# Loads everything inside master folder
def Load_From_Master():
    ...
    for file_name in list_of_files:
        ...
        doc = open(file_name, "rt")
        data = doc.read()
        print("Loaded everything > master : {} ".format(file_name))
...
img_logo = Label(root,image=img).pack(side='top')

# Buttons
left_frame = Frame(root)
button5 = Button(root, text='Load > Master', command=Load_From_Master, height='2', width='20').pack(padx='0', pady='10')
button1 = Button(root, text='Change > Color', command=Transform_Color, height='2', width='20').pack(padx='0', pady='10')
button2 = Button(root, text='Change > Circle', command=Transform_to_Circle, height='2', width='20').pack(padx='0', pady='10')
button3 = Button(root, text='Change > Square', command=Transform_to_Square, height='2', width='20').pack(padx='0', pady='10')
button4 = Button(root, text='Remove > Decoration', command=Remove_Decoration, height='2', width='20').pack(padx='0', pady='10')
left_frame.pack(side='left')

# Output window
bottomframe = Frame(root)
output_window = Label(root,text='{}'.format(list_of_files), background='#000000', foreground='#ffffff').pack(fill='x', padx='10', pady='10', side='bottom')
